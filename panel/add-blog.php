            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-7 col-md-offset-2">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Add A New Blog</h4>
                            </div>
                            <div class="content">
                                <form action="submit-blog.php" method="post" enctype="multipart/form-data" onsubmit="checkIsHome()">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Title</label>
                                                <input type="text" class="form-control border-input" name="title" placeholder="Title">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Author</label>
                                                <input type="text" class="form-control border-input" name="author" placeholder="Author">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Content</label>
                                                <textarea id="displayeditor" rows="10" class="form-control border-input ckeditor" name="content" placeholder="Start Writing here"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
